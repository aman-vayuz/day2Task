...
Task _taskDeserialize(
  ...
  final object = Task(
    category: _TaskcategoryValueEnumMap[reader.readByteOrNull(offsets[0])] ??
...
const _TaskcategoryValueEnumMap = {
  0: TaskCategory.Yesterday,
  1: TaskCategory.Today,
  2: TaskCategory.Tomorrow,
};
